...
const Features = () => {
  return (
    <div>
      <div className="px-4 md:px-[100px] py-12 mt-7 grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="px-12">
      ...
      {/* countdown */}
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6 py-7 px-4 md:px-[100px]">
      ...
      <div className="relative h-[550px] w-full flex items-center justify-center overflow-hidden">
        ...
        {/* Content */}
        <div className="relative flex flex-col md:flex-row items-center  text-white px-[150px]">
          <div className="w-1/2">
            <div>
              <div className="flex flex-row items-center  gap-2 mb-5 ">
      ...
      <div className="bg-white relative mx-[50px] md:mx-[100px]  -mt-[150px] rounded-2xl shadow-2xl">
